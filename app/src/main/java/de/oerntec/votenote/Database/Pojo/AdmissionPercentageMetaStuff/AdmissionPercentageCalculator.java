...
public class AdmissionPercentageCalculator {
    public static AdmissionPercentageCalculationResult calculateAll(AdmissionPercentageMetaPojo metaPojo) {
    ...
    private static EstimationModeDependentResults calculateEstimationModeDependentResults(EstimationMode mode,
                                                                                          ...
                                                                                          AdmissionPercentageMetaPojo item) {
     ...
     */
    public static float calcNeededAssignmentsPerLesson(AdmissionPercentageMetaPojo item, float target, float numberOfFutureLessons) {
     ...
     */
    public static float getEstimatedAssignmentsPerLesson(AdmissionPercentageMetaPojo item) {
     ...
     */
    private static float getEstimatedAssignmentsPerLesson(AdmissionPercentageMetaPojo item, EstimationMode estimationMode) {

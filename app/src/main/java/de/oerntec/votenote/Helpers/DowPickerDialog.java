 ...
 * Dialog to show
 */
public class DowPickerDialog extends DialogFragment implements DialogInterface.OnClickListener, DialogInterface.OnShowListener {
     ...
     */
    public static DowPickerDialog newInstance(int initialDay) {
        DowPickerDialog d = new DowPickerDialog();
        Bundle b = new Bundle();

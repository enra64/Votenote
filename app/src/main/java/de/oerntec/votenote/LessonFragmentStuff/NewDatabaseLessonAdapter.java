...
public class NewDatabaseLessonAdapter extends RecyclerView.Adapter<NewDatabaseLessonAdapter.Holder> {
    ...
    public NewDatabaseLessonAdapter(Context context, int subjectId) {
        mContext = context;
